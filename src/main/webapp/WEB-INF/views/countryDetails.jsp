...
.blue-button {
	background: #25A6E1;
	filter: prodid:DXImageTransform.Microsoft.gradient(startColorstr='#25A6E1',
...
<body>
	<form:form method="post" modelAttribute="country" action="${country.id == null ? 'addCountry' : '../addCountry'}">
